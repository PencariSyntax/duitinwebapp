                    ...
                    <div class="row">
                        <div class="col-lg">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="<?= base_url('auth_team/index'); ?>">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="phone" placeholder="Masukan No Ponsel ..." name="phone" value="<?= set_value('phone'); ?>">
                                    </div>
                                    <div class="form-group">
