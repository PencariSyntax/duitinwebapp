...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <!-- Sidebar -->
        <ul class="navbar-nav sidebar sidebar-dark bg-gradient-success accordion shadow" id="accordionSidebar">

            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('dcp'); ?>">
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('dcp'); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('dcp/data_wakaf'); ?>">
                    <i class="fas fa-fw fa-weight"></i>
                    <span>Data Barang Wakaf</span>
                </a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('dcp/wakaf_barang'); ?>">
                    <i class="fas fa-fw fa-donate"></i>
                    <span>Wakafkan Barang</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('dcp/riwayat_wakaf'); ?>">
                    <i class="fas fa-fw fa-history"></i>
                    <span>Riwayat Data Wakaf</span>
                </a>
            </li>

            <!-- Nav Item - Utilities Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('dcp/profile'); ?>">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('dcp/report'); ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('dcp/about'); ?>">
