...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseDB" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header text-primary">DBase Components:</h6>
                        <a class="collapse-item" href="<?= base_url('dam/tbl_user') ?>">Data Konsumen</a>
                        <a class="collapse-item" href="<?= base_url('dam/tbl_picker') ?>">Data Picker</a>
                        <a class="collapse-item" href="<?= base_url('dam/repair') ?>">Dev Databases</a>
                        <a class="collapse-item" href="<?= base_url('dam/tbl_harga') ?>">Price Database</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('dam/orderlist') ?>">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePC" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header text-primary">Pickers Menu</h6>
