...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion shadow" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url('dpc'); ?>">
                <div class="sidebar-brand-icon">
                    <img src="<?= base_url('assets/img'); ?>/biruduitin.png" alt="" class="img-fluid" width="100" height="55">
                </div>
            </a>
            ...
            <!-- Nav Item - Dashboard -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('dpc'); ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('dpc/sellwastes?picker=') . $name['id_user']; ?>">
                    <i class="fas fa-fw fa-money-bill-wave"></i>
                    <span>Jual Hasil Pengambilan</span>
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('dpc/riwayat_pengambilan?picker=') . $name['id_user']; ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('dpc/profile'); ?>">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('dpc/report'); ?>">
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="<?= base_url('dpc/about'); ?>">
                    <i class="fas fa-fw fa-certificate"></i>
                    <span>Tentang DUITIN Web App</span></a>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Topbar -->
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top text-white">
